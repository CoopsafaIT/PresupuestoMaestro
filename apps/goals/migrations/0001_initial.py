# Generated by Django 3.0.10 on 2022-03-04 13:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, db_column='CreadoPor', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
                ('id_global_goal_period', models.ForeignKey(db_column='IdMetasGlobalesPeriodo', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='goals.GlobalGoalPeriod')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.AutoField(db_column='Id', primary_key=True, serialize=False)),
                ('description', models.CharField(blank=True, db_column='Descripcion', max_length=500, null=True)),
                ('type', models.CharField(blank=True, choices=[('A', 'Automaticas'), ('S', 'Semi Automaticas'), ('M', 'Manuales')], db_column='Tipo', max_length=1, null=True)),
                ('query', models.CharField(blank=True, db_column='SQLQuery', max_length=300, null=True)),
                ('manual_definition', models.CharField(blank=True, db_column='DefinicionManual', max_length=1, null=True)),
                ('manual_execution', models.CharField(blank=True, db_column='EjecucionManual', max_length=1, null=True)),
                ('created_by', models.ForeignKey(blank=True, db_column='CreadoPor', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, db_column='CreadoPor', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
                ('id_global_goal_period', models.ForeignKey(db_column='IdMetasGlobalesPeriodo', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='goals.GlobalGoalPeriod')),
                ('id_goal', models.ForeignKey(db_column='IdMetas', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='goals.Goal')),
